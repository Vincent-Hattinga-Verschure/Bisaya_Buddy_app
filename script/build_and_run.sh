...
MODE="${1:-run}"
EXECUTABLE_NAME="BisayaBuddyMacApp"
...
HTML_SOURCE="$ROOT_DIR/Bisaya Buddy Single File.html"
HTML_DESTINATION="$APP_RESOURCES/Bisaya Buddy Single File.html"
ICON_SOURCE="$ROOT_DIR/assets/icon-512.png"
ICON_DESTINATION="$APP_RESOURCES/BisayaBuddyIcon.png"
CACHE_ROOT="${TMPDIR:-/tmp}/bisaya-buddy-swift-cache"
...
cp "$HTML_SOURCE" "$HTML_DESTINATION"
